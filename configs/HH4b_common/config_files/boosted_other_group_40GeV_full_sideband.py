...
onnx_model_dict  |= {
    ...
    # "bkg_morphing_dnn": "/work/tharte/datasets/ML_pytorch_matteo/out/bkg_reweighting/boosted_vbf/1e-3_e20drop95_minDelta1em5_boosted_reweighting_mass_band_inwards_full_sideband/best_models/average_model_from_onnx.onnx",
...
config_options_dict |= {
    ...
    "TXbb_order": True,
    "boosted_full_sideband": True,
    "bdt_model": "/work/tharte/datasets/bdts/boosted/bdt_trainings_run3/25Feb5_v13_glopartv2_rawmass/trained_bdt.model",
    "save_chunk": "root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/tharte/HH4b/spanet_1_16_9_boosted_other_group_40GeV_full_sideband",
} | onnx_model_dict
