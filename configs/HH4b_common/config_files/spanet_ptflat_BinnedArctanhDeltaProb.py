...
config_options_dict |= {
    ...
    "sig_bkg_dnn_input_variables": dnn_vars.sig_bkg_dnn_BinnedArctanhDeltaProb_input_variables,
    "bkg_morphing_dnn_input_variables": dnn_vars.bkg_morphing_dnn_BinnedArctanhDeltaProb_input_variables,
