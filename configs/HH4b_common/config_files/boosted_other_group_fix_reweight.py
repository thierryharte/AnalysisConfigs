...
onnx_model_dict  |= {
    ...
    # "bkg_morphing_dnn": "/work/tharte/datasets/ML_pytorch_matteo/out/bkg_reweighting/boosted_vbf/1e-3_e20drop95_minDelta1em5_boosted_reweighting_mass_band_inwards_smaller_control_region/best_models/average_model_from_onnx.onnx",
...
config_options_dict |= {
    ...
    "save_chunk": "root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/tharte/HH4b/spanet_1_16_7_boosted_data_reweight_mass_inwards_fixed_reweight",
} | onnx_model_dict
