    ...
    for category, col_var in cat_col.items():
        for quantity_name, var_dict in total_var_dict.items():
            ...
            for i, variable in enumerate(var_dict["variables"]):
                ...
                # Build numerator histogram only (den is useless)
                ...
                hist_1d_dict[var_name] = {
                    ...
                    "style": {
                        "color": (
                            var_dict["colors"][i] if "colors" in var_dict else None
                        ),
            ...
            # Output name
            output_name = os.path.join(outputdir, f"{category}_{quantity_name}")
